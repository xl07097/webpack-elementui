            ...
            <div slot="header" class="header">
                ...
                <ul class="action-box">
                    <li v-if="!closeOnly" @click="minimize">
                        <img style="margin-top: 20px" src="../assets/common/min_window.png"/>
                    </li>
                    <li v-if="!closeOnly" @click="toggleMax">
                        <img style="margin-top: 15px" :src="maxOrNormal"/>
                    </li>
                    <li class="close" @click="close">
                        <img style="margin-top: 15px;width: 11px" src="../assets/common/close.png"/>
                    </li>
                </ul>
            </div>
            <slot></slot>
