...
<style lang="scss">
    .monitorService {
        ...
        .wrapper {
            ...
            box-shadow: 0 12px 57px 0 rgba(153, 220, 214, 0.22);
            border-radius: 6px;
        }
        .headers {
            display: flex;
        ...
        .bg-time {
            ...
            .tips {
                ...
                line-height: 58px;
                text-shadow: 0 1px 1px rgba(81, 83, 84, 0.26);
            }
            .times {
                margin-left: 20px;
                font-size: 14px;
