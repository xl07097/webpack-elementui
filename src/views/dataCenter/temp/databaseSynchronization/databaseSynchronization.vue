<template>
    <div class="databaseSynchronization">
        <div class="content-box clearfix">
            <div class="title">
                数据库同步计划
            </div>
            <Form ref="formInline" :model="formInline" inline style="margin-top: 34px;">
                <FormItem label="源数据库" :label-width="85">
                    <Select v-model="formInline.oldDataBase" style="width:140px">
                        <Option value="0">全部</Option>
                    </Select>
                </FormItem>
                <FormItem label="目标数据库" :label-width="90">
                ...
                <FormItem label="同步方式" :label-width="85">
                    <Select v-model="formInline.style" style="width:140px">
                        <Option value="0">全部</Option>
                    </Select>
                </FormItem>
