<template>
    <div class="genderPhysicalReport content-box">
        <h3 class="title">性别汇总报告单</h3>
        <Form class="clearfix" inline label-position="left">
            <FormItem label="性别" :label-width="44">
                <i-select v-model="req.gender" style="width:140px">
            ...
            return {
                ...
                titleRows: [
                    [
                        ...
                        {fields: ['real_num'], title: '实检人数', titleAlign: 'left', rowspan: 2},
