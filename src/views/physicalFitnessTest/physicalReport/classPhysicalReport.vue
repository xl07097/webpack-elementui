<template>
    <div class="classPhysicalReport content-box">
    ...
    export default {
        ...
        data() {
            return {
                ...
                titleRows: [
                    [
                        {fields: ['class_name',], title: '班级', titleAlign: 'left', rowspan: 2},
                        {fields: ['population'], title: '学生人数', titleAlign: 'left', rowspan: 2},
                        {fields: ['real_numme'], title: '实检人数', titleAlign: 'left', rowspan: 2},
                        {
                            fields: ['BMI_per1', 'BMI_per2', 'BMI_per3', 'BMI_per4'],
                            title: 'BMI',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['vitalcapacity_per1', 'vitalcapacity_per2', 'vitalcapacity_per3', 'vitalcapacity_per4'],
                            title: '肺活量',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['sit_per1', 'sit_per2', 'sit_per3', 'sit_per4'],
                            title: '坐位体前屈',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['longjump_per1', 'longjump_per2', 'longjump_per3', 'longjump_per4'],
                            title: '立定跳远',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['chinning_per1', 'chinning_per2', 'chinning_per3', 'chinning_per4'],
                            title: '引体向上',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['situps_per1', 'situps_per2', 'situps_per3', 'situps_per4'],
                            title: '一分钟仰卧起坐',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['run50_per1', 'run50_per2', 'run50_per3', 'run50_per4'],
                            title: '50米跑',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['run50_8_per1', 'run50_8_per2', 'run50_8_per3', 'run50_8_per4'],
                            title: '50米跑*8往返',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['run800_per1', 'run800_per2', 'run800_per3', 'run800_per4'],
                            title: '800米跑',
                            titleAlign: 'center',
                            colspan: 4
                        },
                        {
                            fields: ['run1000_per1', 'run1000_per2', 'run1000_per3', 'run1000_per4'],
                            title: '1000米跑',
                            titleAlign: 'center',
                            colspan: 4
                        }
